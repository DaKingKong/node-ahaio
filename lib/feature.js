...
module.exports = function(client) {
     ...
     * @param {string} featureId - Numeric ID or key of the feature the comment should be created for
     ...
     * @param callback
     */
    function addComment(featureId, comment, callback) {
        if (_.isEmpty(featureId)) { return callback(new Error('Feature ID required')); }
        ...
        client.post(`${route}/${featureId}/comments`, comment, callback);
    }
